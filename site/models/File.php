...
class File extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['size', 'malware', 'bytes_in_last_block', 'blocks_in_file', 'min_extra_paragraphs', 'overlay_number', 'sizeOfInitializedData', 'numberOfSymbols', 'size_EXPORT', 'size_IAT', 'size_Bound_IAT', 'size_LOAD_CONFIG', 'size_BASERELOC', 'size_CLR_Header'], 'integer'],
